...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelSpace = QtWidgets.QLabel(self.tabStockData)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelSpace.sizePolicy().hasHeightForWidth())
        self.labelSpace.setSizePolicy(sizePolicy)
        self.labelSpace.setMinimumSize(QtCore.QSize(30, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.labelSpace.setFont(font)
        self.labelSpace.setObjectName("labelSpace")
        self.horizontalLayout_5.addWidget(self.labelSpace)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditSpace.setText(_translate("MainWindow", "2"))
        self.labelSpace.setText(_translate("MainWindow", "间隔"))
